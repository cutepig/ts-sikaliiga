...
const randi = (min: number, max: number) => Math.round(randf(min, max));

const generateRandomName = () =>
  `${sample(firstNames)} ${sample(lastNames)}`;
...
export const isLeftWingPosition = (position: PlayerPosition) => position === PlayerPosition.LeftWing;
...
export function createRandomPlayer(position: PlayerPosition, minSkill: number, maxSkill: number): IPlayer {
